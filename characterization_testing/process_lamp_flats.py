...
cells have created test_data/test.db (and ideally after process_arcs.py, so the arcs are
...
from process_arcs import QUERY_PARAMS_SETS, download_frames, process_frames


def make_context():
    """Build a banzai context in this process (same setup as process_arcs._init_worker)."""
...
if __name__ == '__main__':
    ...
    if not args.stack_only:
        process_frames(download_frames('w00'), args.workers)
