...
def test_tracing():
    ...
    fitted_profile_centers, measured_points = fit_profile_centers(binned_data, domains, profile_width=4)
...
def test_profile_width_fitting():
    ...
    binned_data = bin_data(fake_frame.data, fake_frame.uncertainty, fake_frame.wavelengths,
                           fake_frame.orders)
    domains = [center.domain for center in fake_frame.input_profile_centers]
    fitted_widths, measured_points = fit_profile_width(binned_data, fake_frame.input_profile_centers, domains)
